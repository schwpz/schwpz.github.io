...
const ldEvents=ev.slice(0,12).map((e,i)=>({...e,catalogs:{KANDILLI:{depth:i<6?8:14}},sources:['KANDILLI']}));
...
console.log('Self-test OK', {swarm:swarm.score,migration:mig,depth,b,benign:sim.benignBest});
